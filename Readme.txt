...
In a mission with respawn, the killedType can be set to anything else and the marker should be kept with the unit when it respawns, but this functionality is untested.
